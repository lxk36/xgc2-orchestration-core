...
func baseDefinition() contracts.WorkflowDefinition {
	return contracts.WorkflowDefinition{
		...
		Nodes: []contracts.WorkflowNodeDefinition{
			{
				NodeID: "prepare", TypeRef: "xgc.node.transform/v1",
				InputSchema:  object(map[string]contracts.Schema{"name": {Type: contracts.TypeString}}, "name"),
			...
			{
				NodeID: "render", TypeRef: "xgc.node.transform/v1",
...
func TestCompileRejectsCycleDanglingAndUnreachableNodes(t *testing.T) {
	...
	t.Run("unreachable", func(t *testing.T) {
		definition := baseDefinition()
		definition.Nodes = append(definition.Nodes, contracts.WorkflowNodeDefinition{NodeID: "orphan", TypeRef: "xgc.node.noop/v1", InputSchema: object(nil), OutputSchema: object(nil)})
...
func TestCompileRejectsNonDominatingNodeOutput(t *testing.T) {
	...
	definition.Nodes = []contracts.WorkflowNodeDefinition{
		{NodeID: "start", TypeRef: "xgc.node.noop/v1", InputSchema: object(nil), OutputSchema: object(nil)},
		{NodeID: "left", TypeRef: "xgc.node.transform/v1", InputSchema: object(nil), OutputSchema: object(map[string]contracts.Schema{"value": {Type: contracts.TypeString}}, "value")},
		{NodeID: "right", TypeRef: "xgc.node.noop/v1", InputSchema: object(nil), OutputSchema: object(nil)},
		{NodeID: "join", TypeRef: "xgc.node.transform/v1", InputSchema: object(map[string]contracts.Schema{"value": {Type: contracts.TypeString}}, "value"), OutputSchema: object(nil), Bindings: []contracts.ValueBinding{{Target: "/value", Value: contracts.ValueExpr{Ref: "nodes.left.output.value"}}}},
	}
...
func TestCompileRejectsMissingChildInputAndAcceptsExplicitMap(t *testing.T) {
	...
	child := contracts.CallAction{
		...
		InputSchema:     object(map[string]contracts.Schema{"message": {Type: contracts.TypeString}}, "message"),
		ResultSchema:    object(map[string]contracts.Schema{"ok": {Type: contracts.TypeBoolean}}, "ok"),
	}
