...
- a durability port plus a stable-sidecar-locked, committed-v3, checksummed and
  fsynced local file adapter with operation/namespace/resource/authority-scoped
  command replay, revision CAS, inbox dedupe,
